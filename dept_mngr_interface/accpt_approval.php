                ...
                <div class="col-12">
                    <div class="page_title_box d-flex align-items-center justify-content-between">
                        <div class="page_title_left">
                            <h3 class="f_s_30 f_w_700 text_white">Acceptance Approval</h3>
                                ...
                                <table id="myTable" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><span class="badge rounded-pill bg-warning">For Acceptance</span></td>
                                            <td>
                                                <!-- <a class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#editModal">Edit</a> -->
                                                <a class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#accptApptModal">View</a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <!-- <a class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#editModal">Edit</a> -->
                                                <a class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#!">View PDF</a>
                                                <!-- <a class="btn btn-danger btn-sm">Cancel</a> -->
                                            </td>
                                        </tr>
...
<!-- Acceptance Approval Modal -->
<div class="modal fade" id="accptApptModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-body pb-0">
            ...
            <div class="row">
                <div class="col-md-12"> 
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="department" value="Ms. Manager" readonly>
                    </div>
                </div>
            </div><br>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <textarea readonly class="form-control" id="specifyRequest" rows="3" placeholder="The Sample Comment Here"></textarea>
                </div>
            </div><br>
            ...
            <div class="row">
                <div class="col-md-8"> 
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="department" value="Mr. Evaluator Name" readonly>
                    </div>
                </div>
                <div class="col-md-4"> 
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-8"> 
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="department" value="Mr. Sv" readonly>
                    </div>
                </div>
                <div class="col-md-4"> 
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-8"> 
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="department" value="Mr. Manager" readonly>
                    </div>
                </div>
                <div class="col-md-4"> 
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-8"> 
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="department" value="Name of Requestor" readonly>
                    </div>
                </div>
                <div class="col-md-4"> 
                    <div class="form-group">
            ...
            <!-- <div class="row">
                <div class="col-md-8"> 
                    <div class="form-group">
                        <label for="department">Approved by : (Requestor Dept. Manager)</label>
                        <input type="text" class="form-control" id="department" value="To Be Approved" readonly>
                    </div>
                </div>
                <div class="col-md-4"> 
                    <div class="form-group">
                        <label for="department">Date Signed:</label>
                        <input type="text" class="form-control" id="department" value="No Data" readonly>
                    </div>
                </div>
            </div><br> -->
...
<!-- Modal For View Not Approved by Dept Head -->
<div class="modal fade" id="viewNotModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">
        ...
        <div class="modal-body pb-0">
            <div class="row">
                <div class="col-md">
                    <div class="form-group">
                        <label for="requester">Requested by:</label>
                        <input type="text" class="form-control" id="requester" value="Requestor Name" readonly>
                    </div>
                </div>
                <div class="col-md"> 
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-12"> 
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="depthead" value="To Be Approved" readonly>
                    </div>
                </div>
            </div><br>
...
<!-- Modal For View Approved by Dept Head -->
<div class="modal fade" id="viewWithModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">
        ...
        <div class="modal-body pb-0">
            ...
            <div class="row">
                <div class="col-md-12"> 
                    <div class="form-group">
                        <label for="department">Approved by:</label>
                        <input type="text" class="form-control" id="depthead" value="Ms/Mr. Manager" readonly>
                    </div>
                </div>
            </div><br>
