                ...
                <div class="col-12">
                    <div class="page_title_box d-flex align-items-center justify-content-between">
                        <div class="page_title_left">
                            <h3 class="f_s_30 f_w_700 text_white">Create Account</h3>
                        ...
                        <a href="#" class="white_btn3" data-bs-toggle="modal" data-bs-target="#addModal">
                            <img src="../images/4.svg" alt="" style="margin-right:8px;">Add user
                        </a>
                    </div>
                </div>
            </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#updateModal">Update</a>
        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-md">
                    <div class="form-group">
                        <label for="requester">Employee ID #:</label>
                        <input type="text" class="form-control" id="requester" value="" readonly>
                    </div>
                </div>
                <div class="col-md"> 
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-md">
                    <div class="form-group">
                        <label for="department">Password:</label>
                        <input type="password" class="form-control" id="department" value="" readonly>
                    </div>
                </div>
            </div>
            <div class="row">
