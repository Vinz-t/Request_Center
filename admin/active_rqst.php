                    ...
                    <div class="page_title_box d-flex align-items-center justify-content-between">
                        <div class="page_title_left">
                            ...
                            <ol class="breadcrumb page_bradcam mb-0">
                                ...
                                <li class="breadcrumb-item">All Active Request</li>
                                ...
                                <table id="myTable" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge rounded-pill bg-danger">1st Approver</span>
                                                ...
                                                <span class="badge rounded-pill bg-primary">For Acceptance</span>
                                                <span class="badge rounded-pill bg-success">Completed</span>
                                            </td>
                                            <td><a class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#submitalModal">View</a></td>
                                        </tr>
