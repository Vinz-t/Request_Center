                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#viewModal">View</a>
                                        ...
                                        <tr>
                                            ...
                                            <td>(No Data)</td>
                                            <td>(No Data)</td>
                                            <td><span class="badge rounded-pill bg-secondary">Ongoing</span></td>
                                            <td>
                                                <!-- <a href="#" class="btn btn-success btn-sm">Edit Request</a> -->
                                                <a href="#" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#viewModal">View Details</a>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo date('F j, Y'); ?></td>
                                            <td>(No Data)</td>
                                            <td><span class="badge rounded-pill bg-warning">For Review</span></td>
                                            <td>
                                                <a href="#" class="btn btn-primary btn-sm">View Details</a>
                                                <!-- <a href="#" class="btn btn-danger btn-sm">My Remarks</a> -->
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>REQ56316</td>
                                            ...
                                            <td>
                                                <a href="#" class="btn btn-success btn-sm">View PDF</a>
                                                <!-- <a href="#" class="btn btn-primary btn-sm">View Details</a>
                                                <a href="#" class="btn btn-danger btn-sm">Cancel Request</a> -->
                                            </td>
                                        </tr>
            ...
            <div class="row">
                <div class="col-md">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="requester" value="" placeholder="Requestor name here..." required>
                    </div>
                </div>
                <div class="col-md"> 
                    <div class="form-group">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">
            <div>Work Order #: REQ12345</div>
            <div>Date Submitted: <?= date('F j, Y'); ?></div>
            <div>Status: <span class="badge rounded-pill bg-primary">Ongoing</span></div>
        </h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body pb-0">
            <div class="row">
                <div class="col-md">
                    <div class="form-group">
                        <label for="requester">Requested by:</label>
                        <input type="text" class="form-control" id="requester" value="" placeholder="Enter your name here..." required>
                    </div>
                </div>
                <div class="col-md"> 
                    <div class="form-group">
...
<script>
    $(document).ready(function(){
        ...
        $('#myTable').DataTable({
            ...
            "columnDefs": [
                {
                    targets: 5, // Column index you want to center
                    createdCell: function (td, cellData, rowData, row, col) {
                        $(td).css('text-align', 'center');
                    }
                },
                {
                    target: 6, // Column index for actions
                    width: "21%", // Set a fixed width for the actions column
                }
            ],
