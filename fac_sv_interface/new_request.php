                ...
                <div class="col-12">
                    <div class="page_title_box d-flex align-items-center justify-content-between">
                        <div class="page_title_left">
                            <h3 class="f_s_30 f_w_700 text_white">New Request</h3>
                        ...
                        <!-- <div>
                            <a href="ongoing_request.php" class="white_btn3">
                                <img src="../images/4.svg" alt="" style="margin-right:8px;">
                                View Ongoing Request
                            </a>
                            <a href="rejected_request.php" class="white_btn3">
                                <img src="../images/4.svg" alt="" style="margin-right:8px;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="#" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#assignModal">View</a>
                                                <a href="#" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#rejectModal">Reject</a>
                                            </td>
                                        </tr>
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body pb-0">
            <div class="row">
                <div class="col-md-8">
                    <label for="requester">Assign Evaluator:</label>
                    <select class="form-select" aria-label="Default select example">
                        <option selected>Select Evaluator</option>
                        <option value="1">Jade</option>
                        <option value="2">Martin</option>
                        <option value="3">Roy</option>
                    </select>
                    <!-- <input type="text" class="form-control" id="requester" value="" placeholder="Name of Evaluator" required> -->
                </div>
                <div class="col-md-4">
                    <label for=""></label>
                    <input type="button" class="form-control btn btn-success" id="requester" value="Assign Evaluator">
            ...
            <div class="row">
                <div class="col-md">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="requester" value="Name of Requestor" placeholder="" readonly>
                    </div>
                </div>
                <div class="col-md"> 
                    <div class="form-group">
