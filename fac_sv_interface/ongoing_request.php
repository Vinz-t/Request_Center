                ...
                <div class="col-12">
                    <div class="page_title_box d-flex align-items-center justify-content-between">
                        <div class="page_title_left">
                            <h3 class="f_s_30 f_w_700 text_white">Ongoing Request</h3>
                        ...
                        <!-- <div>
                            <a href="for_validation.php" class="white_btn3">
                                <img src="../images/4.svg" alt="" style="margin-right:8px;">
                                View For Validation Request
                            </a>
                        </div>   -->
                    </div>
                </div>
                                ...
                                <table id="myTable" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><span>Mr. Evaluator</span></td>
                                            <td>
                                                <span class="badge rounded-pill bg-warning">In Progress</span>
                                                <span class="badge rounded-pill bg-success">Done</span>
                                            </td>
                                            <td>
                                                <a href="#" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#completedModal">View</a>
    ...
    <div class="modal-content">
      <div class="modal-header">
            ...
            <div class="row">
                ...
                <div class="col-md-4"> 
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="dateComplete" name="dateComplete" value="" readonly>
                    </div>
                </div>
            </div><br>
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-secondary disabled">View Attachment</button>
