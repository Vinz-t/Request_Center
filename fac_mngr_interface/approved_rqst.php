                ...
                <div class="col-12">
                    <div class="page_title_box d-flex align-items-center justify-content-between">
                        <div class="page_title_left">
                            <h3 class="f_s_30 f_w_700 text_white">Approved Request</h3>
                            <ol class="breadcrumb page_bradcam mb-0">
                                <!-- <li class="breadcrumb-item"><a href="javascript:void(0);">Salessa </a></li>
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Dashboard</a></li> -->
                                <!-- <li class="breadcrumb-item">Forms</li> -->
                                <li class="breadcrumb-item active">Facility Manager Control Panel</li>
                            </ol>
                        </div>
                                ...
                                <table id="myTable" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge rounded-pill bg-warning">To Review</span>
                                                <span class="badge rounded-pill bg-success">Completed</span>
                                            </td>
                                            <td>
                                                <a class="btn btn-primary btn-sm disabled" data-bs-toggle="modal" data-bs-target="#">View</a>
                                                <!-- <a class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#editModal">Edit</a>
                                                <a class="btn btn-danger btn-sm"data-bs-toggle="modal" data-bs-target="#rejectModal">Reject</a> -->
                                            </td>
                                        </tr>
                                    </tbody>
...
<!-- New Request Modal -->
<div class="modal fade" id="newRqstModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-header">
        ...
        <div class="modal-body pb-0">
            <div class="row">
                <div class="col-md">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="requester" value="Requestor Name" placeholder="" readonly>
                    </div>
                </div>
                <div class="col-md"> 
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="form-group">
                        <label for="requester">Evaluated by:</label>
                        <input type="text" class="form-control" id="requester" value="Mr. Evaluator" placeholder="" readonly>
                    </div>
                </div>
                <div class="col-md-4"> 
                    <div class="form-group">
                        <label for="dateComplete">Date Completed:</label>
                        <input type="text" class="form-control" id="dateComplete" name="dateComplete" value="<?= date('F j, Y'); ?>" readonly>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-8">
                    <div class="form-group">
                        <label for="requester">Checked/Verified by: (Facility Supervisor)</label>
                        <input type="text" class="form-control" id="requester" value="Mr. Supervisor" readonly>
                    </div>
                </div>
                <div class="col-md-4"> 
                    <div class="form-group">
                        <label for="dateComplete">Date Approved:</label>
                        <input type="text" class="form-control" id="dateComplete" name="dateComplete" value="<?= date('F j, Y'); ?>" readonly>
                    </div>
                </div>
            </div><br>
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-secondary">View Attachment</button>
      ...
      <div class="modal-header">
        ...
        <div class="modal-body pb-0">
            ...
            <div class="row">
                <div class="col-md-12">
                    <label for="specifyRequest" class="form-label">Reason of Request:</label>
                    <textarea readonly class="form-control" id="specifyRequest" rows="3" placeholder="Reason of request type here...."></textarea>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <label for="specifyRequest" class="form-label">Reason of Rejection:</label>
                    <textarea class="form-control" id="specifyRequest" rows="3" placeholder="Type here...."></textarea>
                </div>
            </div><br>
