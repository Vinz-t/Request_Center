                ...
                <div class="col-12">
                    <div class="page_title_box d-flex align-items-center justify-content-between">
                        <div class="page_title_left">
                            <h3 class="f_s_30 f_w_700 text_white">Pending</h3>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-danger btn-sm disabled">Cancel</a>
                                            </td>
                                        </tr>
                                    </tbody>
    ...
    <div class="modal-content">
      <div class="modal-header">
            ...
            <div class="row">
                <div class="col-md">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="requester" value="Mr/Ms. Requestors Name" readonly>
                    </div>
                </div>
                <div class="col-md"> 
                    <div class="form-group">
        ...
        <div class="modal-footer">
            ...
            <button type="button" class="btn btn-success">Update My Request</button>
        </div>
    </div>
  </div>
</div>
        ...
        <div class="modal-body pb-0">
            <div class="row">
                <div class="col-md">
                    <div class="form-group">
                        <label for="requester">Requested by:</label>
                        <input type="text" class="form-control" id="requester" value="Ms/Mr. Requestors Name" readonly>
                    </div>
                </div>
                <div class="col-md"> 
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-8"> 
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control text-danger" id="depthead" value="To Be Approved" readonly>
                    </div>
                </div>
                <div class="col-md-4">
                    <label for="department">Date Approved:</label>
                    <input type="text" class="form-control" id="depthead" value="" readonly>
                </div>
            </div><br>
            ...
            <div class="row">
                <div class="col-md-8"> 
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="depthead" value="Ms/Mr. Dept. Manager Name" readonly>
                    </div>
                </div>
                <div class="col-md-4"> 
                    <div class="form-group">
                        <label for="department">Date Approved:</label>
                        <input type="text" class="form-control" id="depthead" value="<?= date('F j, Y'); ?>" readonly>
                    </div>
                </div>
            </div><br>
