                ...
                <div class="col-12">
                    <div class="page_title_box d-flex align-items-center justify-content-between">
                        <div class="page_title_left">
                            <h3 class="f_s_30 f_w_700 text_white">Request Completed</h3>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="#" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#view3Modal">View</a>
...
<!-- Modal For View for 3 Approver-->
<div class="modal fade" id="view3Modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="row">
                <div class="col-md-8"> 
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="department" value="Ms/Mr. Dept Manager" readonly>
                    </div>
                </div>
                <div class="col-md-4"> 
                    <div class="form-group">
