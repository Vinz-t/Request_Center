...
<section class="main_content dashboard_part large_header_bg">
    ...
    <div class="main_content_iner overly_inner ">
        <div class="container-fluid p-0 ">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page_title_box d-flex align-items-center justify-content-between">
                        ...
                        <a href="wor_form.php" class="white_btn3">
                            <img src="../images/4.svg" alt="" style="margin-right:8px;">Work Order Request   
                        </a>
                    </div>
                </div>
            </div>
            ...
            <!-- The Flow of the process of requesting here -->
             <div class="row ">
                <div class="col-lg-9 card_height_100 mb_20">
                    <div class="white_card">
                        <div class="white_card_header ps-3 pe-3 pt-3 pb-0">
                            <div class="box_header m-0">
                                <div class="main-title">
                                    <h2 class="m-0">Process Flow of Work Order Requesting </h3>
                                </div>
                            </div>
                        </div>
                        <div class="white_card_body p-0">
                ...
                <div class="col-lg-3 card_height_100 mb_20">
                    <div class="white_card">
                        <div class="white_card_header">
                            <div class="box_header m-0">
                                <div class="main-title">
                                    <h3 class="m-0">Rejected/Cancelled</h3>
                                </div>
                            </div>
                        </div>
                        <div class="white_card_body p-0">
...
if (sc == 201) {
    ...
    // Remove 'sc' from the URL without reloading the page
