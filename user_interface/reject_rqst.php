                ...
                <div class="col-12">
                    <div class="page_title_box d-flex align-items-center justify-content-between">
                        <div class="page_title_left">
                            <h3 class="f_s_30 f_w_700 text_white">Request Rejected/Cancelled</h3>
                                ...
                                <table id="myTable" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Dept. Manager<br>Fac. Manager or Supervisor<br>User Cancelation</td>
                                            <td>
                                                <!-- <a href="#" class="btn btn-success btn-sm">Edit Request</a> -->
                                                <a href="#" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#rjtRqstModal">View</a>
...
<div class="modal fade" id="rjtRqstModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body pb-0">
            ...
            <div class="row">
                <div class="col-md-12">
                    <label for="specifyRequest" class="form-label">Reason for Rejection :</label>
