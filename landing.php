    ...
    <div class="container-fluid g-0">
        <div class="row">
            <div class="col-lg-12 p-0">
                <div class="header_iner d-flex align-items-center">
                    <div class="sidebar_icon d-lg-none">
                        <i class="ti-menu"></i>
                    </div>
                    <div class="current_datetime text-dark" style="font-size:14px; position:absolute; right:20px; top:50%; transform:translateY(-50%);">
